...
lablegend               = 'Hs (m)';%Wind Speeds in m/s;'Hs (m)'
...
RadialGridColor         = [.5 .5 .5];
CircularGridColor       = [.5 .5 .5];
RadialGridWidth         = 0.5;
...
function FrequecyLabels(circles,radius,angulo,TextColor,textfontname,escala,CenterLocation,rmin)
    ...
    for i=1:length(circles)
        text(radius(i)*c*escala+CenterLocation.X,radius(i)*s*escala+CenterLocation.Y,[num2str(circles(i)) '%'],'HorizontalAlignment',ha,'verticalalignment',va,'color',TextColor,'fontname',textfontname,'fontsize',18); % display the labels for each circle
    end
%     if length(radius)>1
%         rmin = radius(1)-abs(diff(radius(1:2)));
        if rmin>0
            ...
            text(rmin*c*escala+CenterLocation.X,rmin*s*escala+CenterLocation.Y,'0%','HorizontalAlignment',ha,'verticalalignment',va,'color',TextColor,'fontname',textfontname,'fontsize',18); % display the labels for each circle
        end
%     end
...
function CardinalLabels(circlemax,TextColor,labels,lots_of_labels,textfontname,escala,CenterLocation)
    if ~lots_of_labels && isstruct(labels)
        text( circlemax*escala+CenterLocation.X,0+CenterLocation.Y,[' ' labels.E],'HorizontalAlignment','left'  ,'verticalalignment','middle','color',TextColor,'fontname',textfontname,'fontsize',18,'fontweight','b'); % East  label
        text(-circlemax*escala+CenterLocation.X,0+CenterLocation.Y,[labels.W ' '],'HorizontalAlignment','right' ,'verticalalignment','middle','color',TextColor,'fontname',textfontname,'fontsize',18,'fontweight','b'); % West  label
        text(0+CenterLocation.X, circlemax*escala+CenterLocation.Y,labels.N      ,'HorizontalAlignment','center','verticalalignment','bottom','color',TextColor,'fontname',textfontname,'fontsize',18,'fontweight','b'); % North label
        text(0+CenterLocation.X,-circlemax*escala+CenterLocation.Y,labels.S      ,'HorizontalAlignment','center','verticalalignment','top'   ,'color',TextColor,'fontname',textfontname,'fontsize',18,'fontweight','b'); % South label
