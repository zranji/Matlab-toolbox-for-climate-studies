function [AnalogPat,Neig,NeigDist]=getAnalogous(OPRCP,ERACP,NumA,Type,Clustering)
%[AnalogousPatterns,Analogous,AnalogousDistance]=getAnalogous(Pattern,Library,k,Type,Clustering)
