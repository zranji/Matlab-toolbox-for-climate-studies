...
while i<=length(varargin), 
  ...
  if ischar(varargin{i}), 
    switch varargin{i}, 
     ...
     case 'initCodebook', i=i+1; initCodebook = varargin{i};
      % unambiguous values
...
switch initalg, 
 ...
 case 'custominit', sMap = som_randinit(D, sMap); sMap.codebook = initCodebook;  sMap.initCodebook = initCodebook;
end
