...
void prediccionDetPercentile(SDoubleMtx *Prdc,SDoubleMtx *Anlg,SDoubleMtx *Dist,SDoubleMtx *Ptnd,SParamPrd *Param){
...
#endif
		getprctile(PrdcLoc,Param->Umb,PtndAnlg,NA,DistLoc);
#ifdef VERBOSE_PRO	
