...
*
*********************************************************************
* A.  FUNCTION:  grib_dec_heads
*     decode a Gridded Binary (GRIB edition 1) format message
*
*    INTERFACE:
*      int grib_dec_heads (curr_ptr, pds, gds, bds_head, bms, ppgrib_data, errmsg)
*
...
#if PROTOTYPE_NEEDED
int   grib_dec_heads (char *curr_ptr, PDS_INPUT  *pds, grid_desc_sec  *gds,
        	BDS_HEAD_INPUT *bds_head, BMS_INPUT *bms,char *errmsg)
#else
int grib_dec_heads (curr_ptr, pds, gds, bds_head, bms, errmsg)
