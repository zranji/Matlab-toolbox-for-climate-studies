...
%  $Revision: 1.4 $    $Date: 2002/03/20 21:26:06 $
...
if ~isstr(outputformat); error('Output format flag must be a string'); end
if ~isstr(flag); error('Boolean operation flag must be a string'); end
